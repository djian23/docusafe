    ...
    <LegalPageLayout title="Mentions légales" lastUpdated="14 février 2026">
      <section>
        ...
        <div className="text-muted-foreground leading-relaxed space-y-1">
          <p><strong className="text-foreground">Raison sociale :</strong> Koffr SAS</p>
          ...
          <p><strong className="text-foreground">Directeur de publication :</strong> Le Président de Koffr SAS</p>
          <p><strong className="text-foreground">E-mail :</strong> <a href="mailto:contact@koffr.app" className="text-primary hover:underline">contact@koffr.app</a></p>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          L'ensemble du contenu du site Koffr (textes, images, logos, icônes, logiciels, base de données)
          ...
          de ces éléments est interdite sans l'autorisation écrite préalable de Koffr SAS.
        </p>
        <p className="text-muted-foreground leading-relaxed mt-3">
          La marque "Koffr" et le logo associé sont des marques déposées.
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed mt-3">
          Délégué à la protection des données (DPO) : <a href="mailto:dpo@koffr.app" className="text-primary hover:underline">dpo@koffr.app</a>
        </p>
        <p className="text-muted-foreground leading-relaxed mt-3">
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Le site Koffr utilise uniquement des cookies strictement nécessaires au fonctionnement du service
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Le site Koffr peut contenir des liens vers des sites tiers. Koffr ne saurait être tenu
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          <li><strong className="text-foreground">Conception et développement :</strong> Koffr SAS</li>
      ...
      <section>
        ...
        <p className="text-muted-foreground leading-relaxed">
          Conformément aux articles L.616-1 et R.616-1 du Code de la consommation, Koffr propose un dispositif
